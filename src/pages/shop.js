		...
		<Page {...PageConfig}>
			<div className={CSS.shop}>
				<div className={CSS.shopDescription}>
					<p>I first met JoJo in 1999. JoJo and Me tells how it all started. The sequel is a continuation of our friendship plus my relationship with a calf I called Lemon Lips.</p>
					<div>
